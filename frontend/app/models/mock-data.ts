...
export const initialRentals: Rental[] = [
  {
    id: "0x3A5B8c9dE01f2345678901234567890abcdeF456",
    ...
    lateFeeBps: 1000,
    gracePeriod: 432000,
    paymentPeriod: 2592000,
    duration: 31104000,
    deadline: Math.floor(Date.now() / 1000) + 86400,
    startTime: Math.floor(new Date("2025-07-01T00:00:00Z").getTime() / 1000),
    rentPaidUntil: Math.floor(new Date("2026-07-01T00:00:00Z").getTime() / 1000),
    amountToPay: 640,
    lateFeeAmount: 0,
    status: 2,
  ...
  {
    id: "0x9E8d7C6bA50f12345678901234567890abcDEF12",
    ...
    rentPaidUntil: Math.floor(new Date("2026-06-30T00:00:00Z").getTime() / 1000),
    amountToPay: 480,
    lateFeeAmount: 0,
    status: 2,
    landlordApproved: true,
