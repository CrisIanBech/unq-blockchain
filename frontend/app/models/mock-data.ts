...
export const WALLET_ADDRESS = "0x7A3f...91Cd"
...
export const initialOwnedProperties: OwnedProperty[] = [
  {
    ...
    rentalToken: "0xab12Cd34Ef56789012345678abCDef9012345678",
    monthlyRent: 720,
    tenant: "0x4D2e...8Bf1",
  ...
  },
  {
    ...
    rentalToken: "0xcd34Ef5678901234567890abCDef901234567890",
    monthlyRent: 1100,
    tenant: "0x9C7a...2Df4",
  ...
  },
  {
    ...
    rentalToken: "0xef567890abcdef1234567890ABcdef1234567890",
    monthlyRent: 560,
    tenant: null,
...
export const initialListings: Listing[] = [
  {
    ...
    m2: 65,
    reviews: [
      { id: "r1", author: "0x4D2e...8Bf1", rating: 5, comment: "Excelente ubicación y el smartlock funcionó perfecto.", date: "2026-04-10" },
      { id: "r2", author: "0x9C7a...2Df4", rating: 4, comment: "Muy lindo, un poco ruidoso de noche.", date: "2026-02-22" },
    ],
  },
  {
    id: "list-2",
